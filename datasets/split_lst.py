"""
代码功能：将lst文件中的数据列表按照信号个数不同，信噪比snr不同，分到不同的lst文件中
"""
import os

def split_lst_by_category_and_snr(lst_file, output_dir, prefix):
...
# 主函数
def main():
    split_lst_by_category_and_snr('../data/list/train.lst', '../data/all_list', 'train')
    split_lst_by_category_and_snr('../data/list/validation.lst', '../data/all_list', 'validation')
